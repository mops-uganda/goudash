...
<!-- ==========================CONTENT STARTS HERE ========================== -->
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">GOU Dashboard</h1>
						<div class="hero">

							<div class="pull-left login-desc-box-l">
								<h4 class="paragraph-header">It's Okay to be Smart. Experience the simplicity of GOU Dashboard, everywhere you go!</h4>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">About GOU Dashboard - Are you up to date?</h5>
								<p>
 ...
 <div id="left">
            ...
            <h1>GOU Dashboard TERMS & CONDITIONS TEMPLATE</h1>
...
<h2>About these website terms and conditions</h2><p>We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.publicservice.go.ug">www.publicservice.com</a>.
Contractology supply a wide variety of commercial legal documents, such as <a href="#">template data protection statements</a>.
	 ...
	 <a href="#">publicservice.go.ug</a>.  You must retain the credit
