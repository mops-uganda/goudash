...
function loadURL(url, container) {
    ...
    $.ajax({
        ...
        beforeSend : function() {
            ...
            // place cog
            container.html('<h1><i class="fa fa-cog fa-spin fa-3x"></i> Loading...</h1><div class="containerload"><div class="circle"></div><div class="circle"></div><div class="circle"></div></div>');
        ...
        error : function(xhr, status, thrownError, error) {
            if (url == "undefined"){
                ...
                switch (xhr.status){
                    case 404: window.location = "#X/error404"; break;
                    case 500: window.location = "#X/error500"; break;
                    default: container.html('<h4 class="ajax-loading-error"><i class="fa fa-warning txt-color-orangeDark"></i> Error requesting page <span class="txt-color-red">' + url + '</span>: ' + xhr.status + ' <span style="text-transform: capitalize;">'  + thrownError + '</span></h4>'); break;
                }
