...
class Xcrud
{
    ...
    public static function load_js()
    {
        ...
        if (Xcrud_config::$load_jquery)
            $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri . '/dash.min.js"></script>';
        ...
        /* mergerd into dash.min.js $out .= '<script src="' . Xcrud_config::$scripts_url . '/' . Xcrud_config::$plugins_uri .
