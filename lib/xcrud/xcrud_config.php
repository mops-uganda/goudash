...
{
    // default connection
    public static $dbname = 'dash'; // Your database name
    ...
    // theme and language
    public static $theme = 'bootstrap'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of OPMDash visual presentation. For using bootstrap you need to load it on your page.
    ...
    public static $db_time_zone = 'Africa/Kampala'; // database time zone, if you want use system default - leave empty.
    ...
    public static $autoclean_timeout = 20; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
