...
function debugx($msg, $options = null, $return = false) {
    return \Common\Util::debugx($msg, $options, $return);
}

function plog($msg, $return = false) {
    return \Common\Util::debugx($msg, array('dismiss' => false), $return);
}

function clog($msg, $newline = true, $return = false) {
    return \Common\Util::debugx($msg, array('newline' => $newline, 'dismiss' => false), $return);
}
