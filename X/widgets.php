	...
	<div class="col-sm-12">
		...
		<div class="well">
			...
			<h1><span class="semi-bold">Smart</span> <i class="ultra-light">Widgets</i> (aka JarvisWidgets) <sup class="badge bg-color-red bounceIn animated">v 2.0</sup> <br>
				<small class="text-danger slideInRight fast animated"><strong>Exclusive to GOU Dashboard!</strong></small></h1>
			
			<p>The all new and revolutionary JarvisWidgets v2.0 (<strong>$35 value</strong>) is now only exclusive to GOU Dashboard.
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div>
					...
					<div class="widget-body">
						...
						<div class="row">
							...
							<br>
								<br>
							<p>Change widget color at will and GOU Dashboard will permanently remember the color of your chosen widget.
							Do this to any widget in any page and GOU Dashboard will keep track of all your widgets!</p>
							</div>
					...
					<div class="widget-body no-padding">
						...
						<div class="tab-content padding-10">
							...
							<div class="tab-pane fade" id="hr2">
									...
									<h4 class="alert alert-warning"> Checkout the <a href="#X/general-elements.html">General Elements</a> page for more tab options </h4>
			...
			<div class="jarviswidget" id="wid-id-13" 
				data-widget-load="X/demowidget.php"
				data-widget-colorbutton="false" 
				data-widget-colorbutton="false" 
				data-widget-editbutton="false" 
				data-widget-togglebutton="false" 
		...
		<article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<!-- Widget ID (each widget will need unique ID)-->
			<div class="jarviswidget jarviswidget-color-greenLight" id="wid-id-16" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-deletebutton="false">
				<!-- widget options:
					usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
