				...
				<div class="row">
					...
					<div class="col-sm-12">
						<p class="alert alert-info">
							<i class="fa fa-info"></i> Did you know you can add more than just the basic colors to customize your badge? <strong>Learn more about color options modifiers on the <a href="#X/typography.html">Typography page</a>! </strong>
						</p>
						<!-- row -->
						<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="well">
						...
						<a href="X/modal-content/model-content-1.html" data-toggle="modal" data-target="#remoteModal" class="btn btn-primary btn-lg">
							Launch remote modal
						</a>
						...
						<div class="modal fade" id="remoteModal" tabindex="-1" role="dialog" aria-labelledby="remoteModalLabel" aria-hidden="true">  
						    <div class="modal-dialog">  
						        <div class="modal-content">
						        	<!-- content will be filled here from "X/modal-content/model-content-1.html" -->
						        </div>  
						    </div>  
						</div>  
						<!-- /.modal --> 
						...
						<div class="table-responsive">
							...
							<table class="table table-bordered table-striped hidden-mobile">
								...
								<tbody>
									...
									<tr>
										<td colspan="4">	
											<p class="alert alert-success">The traditional bootstrap modal will work a bit different in the GOU Dashboard AJAX version:</p>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="well">
				...
				<p>
					Learn more about other colors that you can use for .well by going to <a href="#X/typography.html"> typography page</a>
				</p>
