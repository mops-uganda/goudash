		...
		<div class="well">
			...
			<table class="table table-striped table-forum">
				<thead>
                    <tr>
                        <th colspan="2">
                        	<a href="#X/forum.php"> Projects </a> > <a href="#X/forum-topic.php">Business Requirement Docs </a> > Nam quam nunc blandit vel
                        </th>
                    </tr>
                </thead>
				<tbody>
					...
					<tr>
                        <td class="text-center">
                        	<a href="#X/profile.php"><img alt="" src="img/flags/us.png"> &nbsp;
					...
					<tr>
                        <td class="text-center">
                        	<a href="#X/profile.php"><img alt="" src="img/flags/es.png"> &nbsp;
					...
					<tr>
                        ...
                        <td>
							...
							<em>- Sadi Orlaf <br> Executive, OPM</em>
