...
<div id="inbox-content" class="inbox-body no-content-padding">
    ...
    <div id="menu-list" class="inbox-side-bar">
        ...
        <ul class="inbox-menu-lg">
            <li class="active">
                <a class="sector-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-circle-o-notch"></i> Sector </a>
            </li>
            <li>
            ...
            <li>
                <a class="dept-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-circle-o-notch"></i> Dept / Project</a>
            </li>
            <li>
                <a class="key-outputs-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-circle-o-notch"></i> Key Outputs</a>
            </li>
            <li>
                <a class="detailed-items-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-circle-o-notch"></i> Line Item Budgets</a>
            </li>
        </ul>

        <h6> Local Governments <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="LGs" class="pull-right txt-color-darken"><i class="fa fa-cube"></i></a></h6>
        <ul class="inbox-menu-lg">
            <li>
                <a class="district-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-cube"></i> District Budgets</a>
            </li>
            <li>
                <a class="mc-load" href="javascript:void(0);"><i class="fa fa-lg fa-fw fa-cube"></i> Municipality Budgets</a>
            </li>
        </ul>


        <div class="air air-bottom inbox-space">
            Item <strong>Budgets</strong>
        </div>
