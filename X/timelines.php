...
<div class="scrollable-page mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" style="height: 723px; position: relative; overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
            <div class="box">
                <div class="box-content">
                    <div id="timeline-content" class="clearfix p15 mb20 mCustomScrollbar _mCS_4 mCS-autoHide" style="height: 703px; position: relative; overflow: visible;"><div id="mCSB_4" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" tabindex="0" style="max-height: none;"><div id="mCSB_4_container" class="mCSB_container" style="position: relative; top: 0px; left: 0px;" dir="ltr">
                                    ...
                                    <form action="http://me.publicservice.go.ug/index.php/timeline/save" id="post-form" class="general-form" role="form" method="post" accept-charset="utf-8" novalidate="novalidate">
                                        <div class="box">
                                            <div class="box-content avatar avatar-md pr15">
                                                <img src="<?php echo ASSETS_URL; ?>/securex/public/upload/users/<?php echo $user->avatar; ?>" alt="..." class="mCS_img_loaded">
                                            </div>
                                            <div id="post-dropzone" class="post-dropzone box-content form-group">
                                                <input type="hidden" name="post_id" value="0">
                                                <input type="hidden" name="reload_list" value="1">
                                                <textarea name="description" cols="40" rows="10" id="post_description" class="form-control white" placeholder="Share an idea or documents..." data-rule-required="1" data-msg-required="This field is required." aria-required="true" aria-invalid="false"></textarea>
                                ...
                                </script>            <div id="timeline">    <div id="post-content-container-2" class="post-content">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <span class="avatar avatar-sm">
                                <img src="http://me.publicservice.go.ug/assets/images/avatar.jpg" alt="...">
                                                        ...
                                                        <!--  only admin and creator can delete the post -->
                                                        <span class="pull-right mt-50 dropdown">
                                <div class="text-off dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                    <i class="fa fa-chevron-down clickable"></i>
                                </div>
                                <ul class="dropdown-menu" role="menu">
        ...
        </div></div><div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-minimal-dark mCSB_scrollTools_vertical mCSB_scrollTools_onDrag_expand" style="display: none;"><div class="mCSB_draggerContainer"><div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 50px; height: 0px; top: 0px;"><div class="mCSB_dragger_bar" style="line-height: 50px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div>