...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h1 class="page-title txt-color-blueDark text-center">
			...
			<!-- PAGE HEADER -->
            GOU Dashboard Different Versions<br>
				<small class="text-success"><strong>When you use GOU Dashboard you will gain access to all the versions below!</strong></small>
		</h1>
	...
	<div class="row">
			...
			<div class="jumbotron padding-10 text-center bg-color-white">
				...
				<div class="text-left padding-5" style="min-height:250px">
					...
					<span class="air air-top-right" style="padding:15px 30px 0 0">
                        ...
                        GOU Dashboard Php 5.5 version, brining you the tools you need to create your project with ease. <i>(Comes in two formats: HTML and AJAX)</i>
						<br>
						<br>	
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="jumbotron padding-10 text-center bg-color-white">
				...
				<div class="text-left padding-5" style="min-height:250px">
					<h5>
						The MVC version of GOU Dashboard finally brings this wonderful theme into the world of .NET. It uses the very latest version of ASP.NET MVC 5 to showcase all of its great features. The MVC version comes complete with built-in ASP.NET Identity and bundling configured to ensure an even more streamlined user experience.
						<br>
						<br>
