...
<script type="text/javascript">
    var search_page = function () {
        document.location.href='#X/search?q='+document.getElementById("search-error").value;
    }
</script>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box">
					...
					<br />
					<p class="lead">
						The page you requested could not be found, either contact the <strong>Ministry of Public Service</strong><br>Use your browsers <b>Back</b> button to return to the page you previously came from
					</p>
					<p class="font-md">
						<b>You may also search using the form below to find what you are looking for</b>
					</p>
					<br>
					<div class="error-search well well-lg padding-10">
						<div class="input-group">
							<input class="form-control input-lg" type="text" placeholder="let's search" id="search-error">
							<span class="input-group-addon" onclick='search_page()'><i class="fa fa-fw fa-lg fa-search"></i></span>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<ul class="list-inline">
								<li>
									&nbsp;<a href="#X/dashboard">Dashbaord</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#X/reports">All Reports</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#X/projects">Strategic Projects</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="#X/meetings">Strategic Actions</a>&nbsp;
								</li>
								<li>
									.
								</li>
								<li>
									&nbsp;<a href="./securex/public">My Profile</a>&nbsp;
								</li>
							</ul>
						</div>
