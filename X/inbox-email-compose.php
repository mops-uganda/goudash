...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		//loadInbox();
		function loadInbox() {
			loadURL("X/email/email-list.html", $('#inbox-content > .table-wrap'))
		}
		...
		//emailView()
		function emailView() {
			loadURL("X/email-opened.html", $('#inbox-content > .table-wrap'));
		}

		emailCompose()
		function emailCompose() {
			loadURL("X/email-compose.html", $('#inbox-content > .table-wrap'));
		}
