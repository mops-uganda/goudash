				...
				<div class="col-sm-12">
					<div class="text-center error-box">
						...
						<p class="lead semi-bold">
							...
							<small>
								We are working hard to correct this issue. Please wait a few moments and try your search again. <br> In the meantime, check out whats new on GOU Dashboard:
							</small>
						</p>
						<ul class="error-search text-left font-md">
				            ...
				            <li><a href="javascript:void(0);"><small>Contact GOU Dashboard IT Staff <i class="fa fa-mail-forward"></i></small></a></li>
