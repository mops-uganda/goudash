...
<div class="alert cardi container-fluid">
    ...
    <div class="col-sm-3 pull-right">
        <span class="pull-right"><strong>From <i class="fa fa-clock-o" style="padding-right: 5px"></i></strong> 12th Feb 2019<br></span>
        <span class="pull-right"><strong>To <i class="fa fa-clock-o" style="padding-right: 5px"></i></strong> 24th Feb 2019</span>
    </div>
